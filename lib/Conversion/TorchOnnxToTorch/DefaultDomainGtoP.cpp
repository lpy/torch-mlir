      ...
      [](OpBinder binder, ConversionPatternRewriter &rewriter) {
        ...
        if (centerPointBox == 1) {
          ...
          Value centers = rewriter.create<Torch::AtenSliceTensorOp>(
              loc, boxType, boxes, const1, const0, const2, const1);
          Value sizes = rewriter.create<Torch::AtenSliceTensorOp>(
              loc, boxType, boxes, const1, const2, const4, const1);
          Value halfSizes = rewriter.create<Torch::AtenDivTensorOp>(
          ...
          Value tensorList = rewriter.create<Torch::PrimListConstructOp>(
              loc, x1y1s.getType(), ValueRange{x1y1s, x2y2s});
          boxes = rewriter.create<Torch::AtenCatOp>(loc, boxType, tensorList,
                                                    const1);
        }
